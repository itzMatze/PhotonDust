...
namespace ve
{
    ...
    Image::Image(const VulkanMainContext& vmc, VulkanCommandContext& vcc, const std::string& filename, bool use_mip_maps, uint32_t base_mip_map_lvl, const std::vector<uint32_t>& queue_family_indices, vk::ImageUsageFlags usage_flags) : vmc(vmc), layer_count(1)
    {
